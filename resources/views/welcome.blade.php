...
<head>
  ...
  <style>
    .bg-tosca {
    background-color: #2ab48b; /* Ubah warna latar belakang menjadi hijau */
    }
    .text-tosca {
    color: #2ab48b; /* Warna hijau tosca */
    }
    .navbar {
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="./images/masjid_1.jpeg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="./images/masjid_2.jpeg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="./images/masjid_3.webp" class="d-block w-100" alt="...">
      </div>
    </div>
    ...
    <div class="col-2 ">
      <nav id="navbar-example3" class="h-100 flex-column align-items-stretch pe-4 border-end ">
        <nav class="nav nav-pills flex-column p-2">
          <a class="nav-link text-center text-tosca" href="#"><b>Waktu Sholat</b></a>
    ...
    <div class="col-10 ">
      <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-smooth-scroll="true" class="scrollspy-example-2" tabindex="0">
        ...
        <div class="my-2" id="item-1-1">
          <div class="card text-center bg-tosca text-white">
            <div class="card-body">
              List Masjid 
            </div>
          </div>
              ...
              <tr>
                <th scope="row">
                  <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                      <a href="https://id.wikipedia.org/wiki/Masjid_Raya_Sumatera_Barat" class="btn btn-link"><i class="bi bi-arrow-right-circle"></i></a>
                    </div>
                  </div>
                </th>
                <td></td>
        ...
        <div id="item-1-2">
          ...
          <div class="container">
            <div class="row mt-3">
              <div class="col-md-4">
                <div class="card">
                  <div class="card-body bg-tosca text-white d-flex flex-column align-items-center justify-content-center rounded-4 p-4">
                    <i class="bi bi-person-fill fs-2 mb-3"></i>
                    <p class="card-text mb-3" style="font-size: 1.25rem;">Nurvina Putri</p>
                    <p class="card-text mb-3" style="font-size: 1.25rem;">211</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="card">
                  <div class="card-body bg-tosca text-white d-flex flex-column align-items-center justify-content-center rounded-4 p-4">
                    <i class="bi bi-person-fill fs-2 mb-3"></i>
                    <p class="card-text mb-3" style="font-size: 1.25rem;">Delpira Afri Susanti</p>
              ...
              <div class="col-md-4">
                <div class="card">
                  <div class="card-body bg-tosca text-white d-flex flex-column align-items-center justify-content-center rounded-4 p-4">
                    <i class="bi bi-person-fill fs-2  mb-3"></i>
                    <p class="card-text mb-3" style="font-size: 1.25rem;">Muhammad AlghifaryNama</p>
...
<!-- Item 3 -->
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="card">
            <img src="./images/foto_3.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Masjid 1</h5>
              <p class="card-text">Mesjid ini merupakan mejid yang ......</p>
            </div>
...
<!-- item 3 -->
  ...
  <footer class="bg-tosca text-white pt-4 pb-4" style="border-radius: 20px 20px 0 0; margin-top: 30px;">
